...
import time
# 设置随机种子
features = np.load("/gpfs/home3/wangxi/RF_tune_pars/DATA_inputs/inputs_desc_v2.npy")[:,:11]
target = np.load("/gpfs/home3/wangxi/RF_tune_pars/DATA_inputs/spl3_desc_v2.npy")
...
import time
start = time.time()
rfc = RandomForestRegressor(n_estimators = 1400,
                            max_depth = 20,
                            max_features = 0.5,
                            min_samples_split = 2,
                            min_samples_leaf = 5,
...
mat_path = '/gpfs/home3/wangxi/RF_tune_pars/rf_outputs/RF_SPL3SM_desc_v0.mat'
io.savemat(mat_path, {'rfsmap_desc': smap_gapfilled})